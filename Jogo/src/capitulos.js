...
export const capitulos = {
    ...
    florestaCorda:{
        titulo: "Na Floresta",
        descricao: "Você e a Lucy seguem pela floresta e se deparam com um portão, uma figura misteriosa aparece, Lucy solta um grito que atiça a criatura que ataca vocês dois. Lucy morre e você é atacado perdendo uma vida, mas consegue fugir para o celeiro.",
        url:"",
        escolhas: {
            correr:{
    ...
    fimAtaque:{
        titulo: "Você foge da criatura",
        descricao:"Você consegue fugir, mas a criatura te tira uma vida",
        url:"",
        escolhas:{
            voltar:{
                texto: "Voltar",
